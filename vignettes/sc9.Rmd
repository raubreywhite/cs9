...
#> $data
#> {xml_document}
#> <weatherdata noNamespaceSchemaLocation="https://schema.api.met.no/schemas/weatherapi-0.4.xsd" created="2023-03-10T06:56:31Z" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
#> [1] <meta>\n  <model name="met_public_forecast" termin="2023-03-10T07:00:00Z" runended="2023-03-10T06:41:46Z" nextrun="2023-03-10T07:41:46Z" from=" ...
#> [2] <product class="pointData">\n  <time datatype="forecast" from="2023-03-10T06:00:00Z" to="2023-03-10T06:00:00Z">\n    <location altitude="252" l ...
#> 
#> $hash
#> $hash$current
...
#>          date tg   tx    tn
#> 1: 2023-03-11 NA  0.6 -10.1
#> 2: 2023-03-12 NA  0.9 -11.4
#> 3: 2023-03-13 NA  0.2  -8.7
#> 4: 2023-03-14 NA -0.1  -2.6
#> 5: 2023-03-15 NA  3.1  -4.8
#> 6: 2023-03-16 NA  1.3  -7.2
#> 7: 2023-03-17 NA  2.0  -2.7
#> 8: 2023-03-18 NA  4.1  -1.0
#> 9: 2023-03-19 NA  3.4  -3.9
#> [1] "Data after missing structural variables filled in"
#>             [unified]         [unified]      [unified]       [unified]   [unified]     [unified]     [unified]   [unified]   [unified]
#>           <character>       <character>    <character>     <character>   <integer>   <character>   <character>   <integer>   <integer>
...
#> 1:                day            county            nor        county03        2020         total         total        2023          10
#> 2:                day            county            nor        county03        2020         total         total        2023          10
#> 3:                day            county            nor        county03        2020         total         total        2023          11
#> 4:                day            county            nor        county03        2020         total         total        2023          11
#> 5:                day            county            nor        county03        2020         total         total        2023          11
#> 6:                day            county            nor        county03        2020         total         total        2023          11
#> 7:                day            county            nor        county03        2020         total         total        2023          11
#> 8:                day            county            nor        county03        2020         total         total        2023          11
#> 9:                day            county            nor        county03        2020         total         total        2023          11
#> 
#>        [unified]     [unified]    [unified]   [unified]   [unified]      [unified]    [unified]   [context]   [context]   [context]
#>      <character>   <character>    <numeric>   <integer>   <integer>    <character>       <Date>   <logical>   <numeric>   <numeric>
#>           NA=0 %        NA=0 %       NA=0 %      NA=0 %      NA=0 %         NA=0 %       NA=0 %    NA=100 %      NA=0 %      NA=0 %
#>      isoyearweek        season   seasonweek     calyear    calmonth   calyearmonth         date          tg          tx          tn
#> 1:       2023-10     2022/2023           33        2023           3       2023-M03   2023-03-11          NA         0.6       -10.1
#> 2:       2023-10     2022/2023           33        2023           3       2023-M03   2023-03-12          NA         0.9       -11.4
#> 3:       2023-11     2022/2023           34        2023           3       2023-M03   2023-03-13          NA         0.2        -8.7
#> 4:       2023-11     2022/2023           34        2023           3       2023-M03   2023-03-14          NA        -0.1        -2.6
#> 5:       2023-11     2022/2023           34        2023           3       2023-M03   2023-03-15          NA         3.1        -4.8
#> 6:       2023-11     2022/2023           34        2023           3       2023-M03   2023-03-16          NA         1.3        -7.2
#> 7:       2023-11     2022/2023           34        2023           3       2023-M03   2023-03-17          NA           2        -2.7
#> 8:       2023-11     2022/2023           34        2023           3       2023-M03   2023-03-18          NA         4.1          -1
#> 9:       2023-11     2022/2023           34        2023           3       2023-M03   2023-03-19          NA         3.4        -3.9
#> Task ran in 0 mins
```
