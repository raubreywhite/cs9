...
#> $data
#> {xml_document}
#> <weatherdata noNamespaceSchemaLocation="https://schema.api.met.no/schemas/weatherapi-0.4.xsd" created="2023-03-10T06:06:15Z" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
#> [1] <meta>\n  <model name="met_public_forecast" termin="2023-03-10T06:00:00Z" runended="2023-03-10T ...
#> [2] <product class="pointData">\n  <time datatype="forecast" from="2023-03-10T06:00:00Z" to="2023-0 ...
#> 
#> $hash
#> $hash$current
...
#>          date tg   tx    tn
#> 1: 2023-03-11 NA  0.9 -10.2
#> 2: 2023-03-12 NA  1.4  -9.5
...
#>      <character>   <integer>   <integer>   <character>   <character>    <numeric>   <integer>
#>           NA=0 %      NA=0 %      NA=0 %        NA=0 %        NA=0 %       NA=0 %      NA=0 %
#>              sex     isoyear     isoweek   isoyearweek        season   seasonweek     calyear
#> 1:         total        2023          10       2023-10     2022/2023           33        2023
#> 2:         total        2023          10       2023-10     2022/2023           33        2023
#> 3:         total        2023          11       2023-11     2022/2023           34        2023
#> 4:         total        2023          11       2023-11     2022/2023           34        2023
#> 5:         total        2023          11       2023-11     2022/2023           34        2023
#> 6:         total        2023          11       2023-11     2022/2023           34        2023
#> 7:         total        2023          11       2023-11     2022/2023           34        2023
#> 8:         total        2023          11       2023-11     2022/2023           34        2023
#> 9:         total        2023          11       2023-11     2022/2023           34        2023
#> 
#>      [unified]      [unified]    [unified]   [context]   [context]   [context]
#>      <integer>    <character>       <Date>   <logical>   <numeric>   <numeric>
#>         NA=0 %         NA=0 %       NA=0 %    NA=100 %      NA=0 %      NA=0 %
#>       calmonth   calyearmonth         date          tg          tx          tn
#> 1:           3       2023-M03   2023-03-11          NA         0.9       -10.2
#> 2:           3       2023-M03   2023-03-12          NA         1.4        -9.5
#> 3:           3       2023-M03   2023-03-13          NA         0.2        -8.7
#> 4:           3       2023-M03   2023-03-14          NA        -0.1        -2.6
#> 5:           3       2023-M03   2023-03-15          NA         3.1        -4.8
#> 6:           3       2023-M03   2023-03-16          NA         1.3        -7.2
#> 7:           3       2023-M03   2023-03-17          NA           2        -2.7
#> 8:           3       2023-M03   2023-03-18          NA         4.1          -1
#> 9:           3       2023-M03   2023-03-19          NA         3.4        -3.9
