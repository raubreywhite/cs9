...
<img src="tasks-task-general.png" title="A general task showing the many options of a task" width="100%" />
...
```
#> Error in knitr::include_graphics(system.file("vignette_resources/tasks/file_locations.png", : Cannot find the file(s): ""
```
