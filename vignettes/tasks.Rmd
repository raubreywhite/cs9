...
This is the thing that **'does stuff'** in Sykdomspulsen Core.</td>
</tr>
<tr>
...
<td style='padding-left: .4em; padding-right: .2em; padding-top: .4em; padding-bottom: .4em; font-size: 14px; border-bottom: 1px dashed grey; width: 80%; border-right: 1px solid black; text-align: left;'>A `sc analysis` is essentially a `plnr analysis` with database schemas:
<ul>
  <li>1 argset</li>
  <li>1 action_fn</li>
</ul></td>
...
<figure>
<img src="tasks-task-general.png" width="100%" />
...
<figure>
<img src="tasks-file-locations.png" width="100%" />
<figcaption>Figure 2. A typical file setup for an implementation of Sykdomspulsen Core. $plan_argset_fn$ is rarely used, and is therefore shown as blacked out in the most of the tasks..</figcaption>
</figure>
...
We begin by creating a surveillance system
...
#> given fields: granularity_time, granularity_geo, country_iso3, location_code, border, age, sex, isoyear, isoweek, isoyearweek, season, seasonweek, calyear, calmonth, calyearmonth, date, tg, tx, tn
#> db fields: granularity_time, granularity_geo, country_iso3, location_code, border, age, sex, isoyear, isoweek, isoyearweek, season, seasonweek, calyear, calmonth, calyearmonth, date, tg, tx, tn, rr
#> Dropping table anon_example_weather because fields dont match
#> Dropping table anon_example_weather
...
#> $data
#> {xml_document}
#> <weatherdata noNamespaceSchemaLocation="https://schema.api.met.no/schemas/weatherapi-0.4.xsd" created="2023-03-09T11:03:35Z" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
#> [1] <meta>\n  <model name="met_public_forecast" termin="2023-03-09T11:00:00Z" runended="2023-03-09T ...
#> [2] <product class="pointData">\n  <time datatype="forecast" from="2023-03-09T11:00:00Z" to="2023-0 ...
#> 
#> $hash
#> $hash$current
...
<img src="tasks-task-import-data.png" width="100%" />
...
<img src="tasks-task-analysis.png" width="100%" />
...
<img src="tasks-task-export-multiple-results.png" width="100%" />
...
<img src="tasks-task-export-combined-results.png" width="100%" />
