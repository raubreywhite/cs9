...
`config_db.r` contains all of the [Surveillance Core 9 db schemas](analytics_db_schemas_introduction.html) definitions. i.e. A long list of `sc::add_schema_v8` commands.
